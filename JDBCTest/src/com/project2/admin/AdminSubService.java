...
public class AdminSubService {
	...
	public void add() {//헌정0417수정 while 문 삭제
...
///////////////////////////////////////////////////////////////////
	public void tEdit() {
		...
		for (TeacherDTO dto : list) {
			System.out.printf("%s\t%-15s\t%s\t%s\n", dto.getSeq(), dto.getName(), dto.getTel(), dto.getAddress());//0417헌정수정
		}
...
////////////////////////////////////////////////////////////////////
	...
	public void tDel() {
		...
		for (TeacherDTO dto : list) {
			System.out.printf("%-4s\t%-15s\t%-10s\t%-13s\t%s\t%s\t%s\n" //0417헌정수정
								, dto.getSeq(), dto.getName(), dto.getSsn(), dto.getTel()
								, dto.getRegdate(), dto.getDelete_status(), dto.getAddress());
		}
		...
		if(del.equals("y")) {
			...
			if (result == 1) {
				System.out.println("교사 정보 삭제 성공");
			} else {
